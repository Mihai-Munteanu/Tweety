                ...
                <div class="font-bold text-lg mb-4">{{ __('Login') }}</div>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input class="border border-grey-400 p-2 w-full" type="text" name="email" id="email" autocomplete="emal" value="{{ old('email') }}" required>
                        ...
                        <div class="mb-6">
                            ...
                            <input class="border border-grey-400 p-2 w-full" type="password" name="password" id="password" autocomplete="current-password" value="{{ old('password') }}" required>
