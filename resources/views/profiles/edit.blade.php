<x-app>
    <form method="POST" action="{{ $user->path() }}" enctype="multipart/form-data">
        <!-- enctype este pentru a putea incarca fisiere-->
        @csrf
        @method('PATCH')
        ...
        <div class="mb-6">
            ...
            <input class="border border-gry-400 p-2 w-full" type="text" name="username" id="name" value="{{$user->username}}" required>
            @error('username')
                <p class="text-red-500 text-xs mt-2"> {{ $message }}</p>
            @enderror
        </div>
        <div class="mb-6">
            ...
            <div class="flex">
                <input class="border border-gry-400 p-2 w-full" type="file" name="avatar" id="name" value="{{$user->avatar}}">
        ...
        <div class="mb-6">
            ...
            <input class="border border-gray-400 p-2 w-full" type="email" name="email" id="name" value="{{$user->email}}" required>
            @error('email')
                <p class="text-red-500 text-xs mt-2"> {{ $message }}</p>
            @enderror
        </div>
